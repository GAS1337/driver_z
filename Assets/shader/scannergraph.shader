...
PS
{
	...
	CreateInputTexture2D( Texture_ps_0, Srgb, 8, "None", "_color", ",0/,0/0", DefaultFile( "materials/graveyard kit colormap.png" ) );
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 l_0 = Tex2DS( g_tTexture_ps_0, g_sSampler0, float2( g_flTime, g_flTime ) );
